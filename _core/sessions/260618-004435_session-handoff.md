...
| Phase 7.3 | Multiclass MLP 튜토리얼 작성 | `docs/stage7/phase7.3_tutorial-mlp.md` |
| Phase 7.4 | Binary MLP 튜토리얼 작성 | `docs/stage7/phase7.4_tutorial-mlp.md` |
| Phase 7.5 | Regression MLP 튜토리얼 작성 | `docs/stage7/phase7.5_tutorial-mlp.md` |
...
| 3 | CNN을 계속 보류할 경우 CNN 튜토리얼 todo 처리 방침 결정 | `_core/PROJECT-TODO.md` |
...
- MLP 튜토리얼: `docs/stage7/phase7.3_tutorial-mlp.md`, `docs/stage7/phase7.4_tutorial-mlp.md`, `docs/stage7/phase7.5_tutorial-mlp.md`
