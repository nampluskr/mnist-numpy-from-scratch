...
- [x] `tests/stage4/test_experiment.py` 작성 (CNN 통합 케이스 추가)
- [x] `scripts/train.py` 구현 (`--model` 플래그 추가, choices: mlp, cnn, default: mlp)
- [x] `scripts/evaluate.py` 구현 (`--model` 플래그 추가)
- [x] `scripts/predict.py` 구현 (`--model` 플래그 추가)
- [x] `scripts/visualize.py` 구현 (`--model` 플래그 추가)
- [x] `tests/stage6/test_train.py` 작성 (`--model` MLP/CNN 테스트 케이스 추가)
- [x] `tests/stage6/test_evaluate.py` 작성 (`--model` MLP/CNN 테스트 케이스 추가)
- [x] `tests/stage6/test_predict.py` 작성 (`--model` MLP/CNN 테스트 케이스 추가)
- [x] `tests/stage6/test_visualize.py` 작성 (`--model` MLP/CNN 테스트 케이스 추가)
- [x] [[docs/stage4/phase4.2_cnn-integration|phase4.2_cnn-integration.md]] 문서 작성

### 5.3. Phase 4.3 Stage 4 노트북 작성
...
- [x] `tests/stage5/test_checkpoints.py` 작성
...
- [x] `tests/stage5/test_trainer.py` 작성
...
- [x] `tests/stage5/test_evaluator.py` 작성
...
- [x] `tests/stage5/test_predictor.py` 작성
...
- [x] `tests/stage5/test_experiment.py` 작성
...
- [x] `tests/stage5/test_visualizer.py` 작성
