...
- [x] `notebooks/stage3/stage3-2_losses-and-metrics.ipynb` 작성
- [x] `notebooks/stage3/stage3-3_layers.ipynb` 작성
- [x] `notebooks/stage3/stage3-4_conv-architecture.ipynb` 작성
...
- [x] `notebooks/stage4/stage4-1_mlp.ipynb` 작성
- [x] `notebooks/stage4/stage4-2_cnn-model.ipynb` 작성
...
- [x] `notebooks/stage5/stage5-3_predictor-and-visualizer.ipynb` 작성
...
- [x] `notebooks/stage6/stage6-1_cli-and-experiments.ipynb` 작성
- [x] `notebooks/stage6/stage6-2_multiclass-experiment.ipynb` 작성
- [x] `notebooks/stage6/stage6-3_binary-experiment.ipynb` 작성
- [x] `notebooks/stage6/stage6-4_regression-experiment.ipynb` 작성
