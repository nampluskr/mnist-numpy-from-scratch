...
prediction 결과 시각화와 training log helper를 구현하기 위한 작업은 다음과 같다.
...
- [x] `notebooks/stage6/stage6-1_cnn-architecture.ipynb` 작성
- [x] `notebooks/stage6/stage6-2_cnn-training.ipynb` 작성
