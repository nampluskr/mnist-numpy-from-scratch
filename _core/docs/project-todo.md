...
- [x] docs/contents/stage00/phase0.1_legacy-review.md
...
- [x] tests 폴더 구조 확정
- [x] docs/contents/stage00/phase0.2_structure.md
...
- [x] docs/contents/stage00/phase0.3_implementation-order.md
...
- [ ] docs/contents/stage01/phase1.1_config.md

### Phase 1.2 task — 과제 규약, target 변환, loss, metric

- [ ] src/task.py
- [ ] tests/test_task.py
- [ ] docs/contents/stage01/phase1.2_task.md

### Phase 1.3 utils — 배치 처리, 난수 시드, 파일 I/O

- [ ] src/utils/batching.py
- [ ] tests/utils/test_batching.py
- [ ] src/utils/random.py
- [ ] tests/utils/test_random.py
- [ ] src/utils/io.py
- [ ] tests/utils/test_io.py
- [ ] docs/contents/stage01/phase1.3_utils.md
...
- [ ] src/data/mnist.py
- [ ] tests/data/test_mnist.py
- [ ] docs/contents/stage02/phase2.1_mnist.md
...
- [ ] docs/contents/stage05/phase5.1_train.md

### Phase 5.2 evaluate — 평가 CLI, experiment · evaluator 호출

- [ ] scripts/evaluate.py
- [ ] tests/scripts/test_evaluate.py
- [ ] docs/contents/stage05/phase5.2_evaluate.md

### Phase 5.3 predict — 예측 CLI, experiment · predictor 호출

- [ ] scripts/predict.py
- [ ] tests/scripts/test_predict.py
- [ ] docs/contents/stage05/phase5.3_predict.md

### Phase 5.4 visualize — 시각화 CLI, experiment · visualizer 호출

- [ ] scripts/visualize.py
- [ ] tests/scripts/test_visualize.py
- [ ] docs/contents/stage05/phase5.4_visualize.md
...
- [ ] docs/contents/stage06/phase6.1_cnn.md

### Phase 6.2 CNN-core 연동 — core 인터페이스 통합 검증

- [ ] tests/core/test_experiment.py (CNN 통합 케이스 추가)
- [ ] docs/contents/stage06/phase6.2_cnn-integration.md

## Stage 7 문서화 · 검증

### Phase 7.1 튜토리얼 — Jupyter Book 챕터 작성

- [ ] docs/contents/stage07/ 챕터 작성

### Phase 7.2 실행 예제 — task별 로그, 평가 결과, 시각화 정리

- [ ] outputs/ 결과 정리
- [ ] docs/contents/stage07/phase7.2_results.md

### Phase 7.3 프레임워크 연계 — 후속 프로젝트 초기화 체크리스트

- [ ] docs/contents/stage07/phase7.3_framework-checklist.md
