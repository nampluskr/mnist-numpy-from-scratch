...
- [ ] src/data/mnist.py (MnistDataset 추가)
- [ ] tests/stage2/test_dataset.py
- [ ] docs/stage2/phase2.2_dataset.md

### Phase 2.3 dataloader — 범용 DataLoader

- [ ] src/data/dataloader.py
- [ ] tests/stage2/test_dataloader.py
- [ ] docs/stage2/phase2.3_dataloader.md
...
### Phase 4.2 trainer — 학습 루프, DataLoader 수신 (fit(train_loader))

- [ ] src/core/trainer.py
- [ ] tests/stage4/test_trainer.py
- [ ] docs/stage4/phase4.2_trainer.md

### Phase 4.3 evaluator — 평가 루프, DataLoader 수신 (evaluate(test_loader))
