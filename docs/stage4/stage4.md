...
Stage 4는 im2col/col2im 기법을 활용한 CNN 모델을 구현하여 Stage 5의 실행 객체와 통합하는 단계이다.
...
conda 환경 구성은 Phase 0.0에서 완료한다.

## 2. Phase 구성

### 2.1. Phase 4.1 CNN model 구현
...
- [[phase4.1_cnn|Phase 4.1 CNN model 구현]]

### 2.2. Phase 4.2 CNN-core integration 검증
...
- [[phase4.2_cnn-integration|Phase 4.2 CNN-core integration 검증]]
...
| `tests/stage4/` | cnn, experiment 테스트 파일 2개 (73개 테스트 통과) |
